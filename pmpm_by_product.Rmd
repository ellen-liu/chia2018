...
```{r create plot}
pmpm_2016_plot <- ggplot(data = pmpm_df, aes(product_type,pmpm_2016)) + geom_bar(stat = "identity", width=0.3, fill="steelblue") + coord_flip() + theme_minimal() + labs(title =" Fully-Insured Premiums by Product Type, 2016", x = "ESI") 
pmpm_2016_plot
