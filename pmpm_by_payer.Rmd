...
enroll_df <- read.csv('enrollment_premiums/enrollment_by_payer.csv', head = T)
...
premium_df <- read.csv('enrollment_premiums/premiums_by_payer.csv', head = T)
...
payer = c('Aetna', 'BCBSMA', 'Cigna', 'Fallon', 'HPHC', 'HNE', 'NHP', 'Total','Tufts', 'UniCare', 'United Healthcare')
