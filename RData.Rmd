...
enroll_df <- read.csv('enrollment_premiums/enrollment_by_employer_size.csv', head = T)
...
premium_df <- read.csv('enrollment_premiums/premiums_by_employer_size.csv', head = T)
...
pmpm_df <- data.frame(employer_size, pmpm_2014, pmpm_2015, pmpm_2016)
